...
for p in data:
    ...
    tabla += fila_tabla.format(fecha_hora_inicio, fecha_hora_termino, comuna, sector, tema, imagen, texto_alt_de_imagen)
...
with open('../templates/header+footer.html', mode='r', encoding="utf-8") as template:
    file = template.read()
