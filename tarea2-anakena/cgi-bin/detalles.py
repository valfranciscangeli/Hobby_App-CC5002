...
def createActividadInfo(datos, region, fotos, contactos, ident):
    ...
    try:
        ...
        #os.chmod(f"../actividad{actividad}.html", 777)
    except:
        informacion = open(f"../actividad{ident}.html", mode="w+", encoding="utf-8")
        #os.chmod(f"../actividad{ident}.html", 777)
